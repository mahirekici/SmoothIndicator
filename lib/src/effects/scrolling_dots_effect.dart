...
import 'package:smooth_page_indicator/src/painters/ScrollingIndexDotsPainter.dart';
...
class ScrollingDotsEffect extends IndicatorEffect {
  ...
  final bool isVisibleIndexNumber;
  ...
  const ScrollingDotsEffect(
      ...
      this.isVisibleIndexNumber = false, // detail app bar için
  ...
  IndicatorPainter buildPainter(int count, double offset) {
    if (fixedCenter) {
      ...
      if (isVisibleIndexNumber) {
        return ScrollingIndexDotsPainter(
            count: count,
            offset: offset,
            effect: this,
            visibleIndexStyle: visibleIndexStyle);
      } else {
